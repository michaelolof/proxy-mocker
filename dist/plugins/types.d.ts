...
import { type MockProxy } from "../mocker";
...
export declare class Server<TIncomingMessage = http.IncomingMessage, TServerResponse = http.ServerResponse> extends events.EventEmitter {
    /**
...
export declare namespace Server {
    ...
    type ErrorCallback<TError = Error, TIncomingMessage = http.IncomingMessage, TServerResponse = http.ServerResponse> = (err: TError, req: TIncomingMessage, res: TServerResponse, target?: ProxyTargetUrl) => void;
}
