...
export declare class Server<TIncomingMessage = http.IncomingMessage, TServerResponse = http.ServerResponse>
...
export type PluginOptions = {
    // This will destroy request from the proxy to the upstream server when a match has been found on the mock repository
    // [Please note:] vite will log an error (Error: socket hang up) when this happens
